...
import com.jiming.daily.business.domain.AckBaseMsg;
import com.jiming.daily.business.domain.DemoLog;
import com.jiming.daily.business.domain.ReqData;
...
//
//		// 组装请求头
//		ReqHead9 head = this.creatSendDataHead(tranCode);
